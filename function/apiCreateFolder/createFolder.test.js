...
const apiCreateFolder = require('./apiCreateFolder');
...
// Перед каждым тестом очищаем содержимое папки и делаем ее пустой только в тесте
beforeEach(() => {
...
describe('copyDirectory', () => {
    it('должна успешно скопировать содержимое директории', (done) => {  // Используем параметр done
        ...
        apiCreateFolder(sourceDir, baseDir);
